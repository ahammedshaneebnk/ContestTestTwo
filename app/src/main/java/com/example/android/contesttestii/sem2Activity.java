    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        syll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(sem2Activity.this, contentActivity.class);
